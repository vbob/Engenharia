...
{\color{incolor}In [{\color{incolor}1}]:} \PY{n}{dist\PYZus{}matrix} \PY{o}{=} \PY{p}{[}
...
estados correspondente ao nó - Pai: O nó da árvore que gerou esse nó -
...
{\color{incolor}In [{\color{incolor}4}]:} \PY{k}{def} \PY{n+nf}{child\PYZus{}node}\PY{p}{(}\PY{n}{parent}\PY{p}{,} \PY{n}{action}\PY{p}{,} \PY{n}{now\PYZus{}cost}\PY{p}{)}\PY{p}{:}
            ...
            \PY{k}{return} \PY{n}{Node}\PY{p}{(}\PY{n}{parent}\PY{o}{.}\PY{n}{state}\PY{p}{,} \PY{n}{parent}\PY{p}{,} \PY{n}{action}\PY{p}{,} \PY{n}{parent}\PY{o}{.}\PY{n}{cost} \PY{o}{+} \PY{n}{now\PYZus{}cost}\PY{p}{)} 
\end{Verbatim}
...
se todas as cidades foram visitadas SOMENTE uma vez.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} Deque =\PYZgt{} Double\PYZhy{}Ended Queue }
        \PY{c+c1}{\PYZsh{} Pode ser utilizada tanto como FIFO quanto como LIFO}
        \PY{k+kn}{from} \PY{n+nn}{collections} \PY{k}{import} \PY{n}{deque}
        
        \PY{k}{class} \PY{n+nc}{TravellingSalesman}\PY{p}{:}
            \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{} Classe para organização de dados do problema \PYZdq{}\PYZdq{}\PYZdq{}}
            
            \PY{k}{def} \PY{n+nf}{\PYZus{}\PYZus{}init\PYZus{}\PYZus{}}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{)}\PY{p}{:}
                \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{seq} \PY{o}{=} \PY{n}{deque}\PY{p}{(}\PY{p}{)}
                \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{state} \PY{o}{=} \PY{n}{initial\PYZus{}state}
            
            \PY{k}{def} \PY{n+nf}{check\PYZus{}goal}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{)}\PY{p}{:}
                \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{} Método que retorna verdadeiro caso o objetivo tenha sido alcançado \PYZdq{}\PYZdq{}\PYZdq{}}
                
                \PY{k}{return} \PY{n+nb}{all}\PY{p}{(}\PY{n}{elem} \PY{o+ow}{in} \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{seq} \PY{k}{for} \PY{n}{elem} \PY{o+ow}{in} \PY{n}{list\PYZus{}of\PYZus{}possible\PYZus{}states}\PY{p}{)} 
                        \PY{o+ow}{and} \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{state} \PY{o}{==} \PY{n}{initial\PYZus{}state}
            
            \PY{k}{def} \PY{n+nf}{possible\PYZus{}states}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{)}\PY{p}{:}
                \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{} Método que retorna lista de cidades que podem ser acessadas }
        \PY{l+s+sd}{        à partir da cidade atual \PYZdq{}\PYZdq{}\PYZdq{}}
                ...
                \PY{k}{return} \PY{p}{[}\PY{n}{state}\PY{o}{+}\PY{l+m+mi}{1} \PY{k}{for} \PY{n}{state}\PY{p}{,} \PY{n}{distance} \PY{o+ow}{in} 
                        \PY{n+nb}{filter}\PY{p}{(}\PY{k}{lambda} \PY{n}{x}\PY{p}{:} \PY{n}{x}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]} \PY{o}{\PYZgt{}} \PY{l+m+mi}{0}\PY{p}{,} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{dist\PYZus{}matrix}\PY{p}{[}\PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{state}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{)}\PY{p}{]}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}6}]:} \PY{n}{salesman} \PY{o}{=} \PY{n}{TravellingSalesman}\PY{p}{(}\PY{p}{)}
        ...
        \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Estado Atual: }\PY{l+s+si}{\PYZpc{}s}\PY{l+s+s1}{ }\PY{l+s+s1}{\PYZsq{}} \PY{o}{\PYZpc{}} \PY{n}{salesman}\PY{o}{.}\PY{n}{state}\PY{p}{)}
        \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Lista de Ações: }\PY{l+s+si}{\PYZpc{}s}\PY{l+s+s1}{\PYZsq{}} \PY{o}{\PYZpc{}} \PY{n}{salesman}\PY{o}{.}\PY{n}{seq}\PY{p}{)}
        \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Estados Possíveis: }\PY{l+s+si}{\PYZpc{}s}\PY{l+s+s1}{ }\PY{l+s+s1}{\PYZsq{}} \PY{o}{\PYZpc{}} \PY{n}{salesman}\PY{o}{.}\PY{n}{possible\PYZus{}states}\PY{p}{(}\PY{p}{)}\PY{p}{)}
        \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Objetivo atingido? }\PY{l+s+si}{\PYZpc{}s}\PY{l+s+s1}{  }\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s1}{\PYZsq{}} \PY{o}{\PYZpc{}} \PY{n}{salesman}\PY{o}{.}\PY{n}{check\PYZus{}goal}\PY{p}{(}\PY{p}{)}\PY{p}{)}
        ...
        \PY{n}{salesman}\PY{o}{.}\PY{n}{state} \PY{o}{=} \PY{l+m+mi}{10}
        \PY{n}{salesman}\PY{o}{.}\PY{n}{seq} \PY{o}{=} \PY{n}{deque}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{,}\PY{l+m+mi}{6}\PY{p}{,}\PY{l+m+mi}{7}\PY{p}{,}\PY{l+m+mi}{8}\PY{p}{,}\PY{l+m+mi}{9}\PY{p}{,}\PY{l+m+mi}{10}\PY{p}{]}\PY{p}{)}
        ...
        \PY{n}{salesman}\PY{o}{.}\PY{n}{state} \PY{o}{=} \PY{l+m+mi}{1}
        \PY{n}{salesman}\PY{o}{.}\PY{n}{seq} \PY{o}{=} \PY{n}{deque}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{,}\PY{l+m+mi}{6}\PY{p}{,}\PY{l+m+mi}{7}\PY{p}{,}\PY{l+m+mi}{8}\PY{p}{,}\PY{l+m+mi}{9}\PY{p}{,}\PY{l+m+mi}{10}\PY{p}{,}\PY{l+m+mi}{9}\PY{p}{,}\PY{l+m+mi}{8}\PY{p}{,}\PY{l+m+mi}{7}\PY{p}{,}\PY{l+m+mi}{6}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}
