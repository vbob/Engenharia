\begin{center}
    ...
    \begin{tabular}{|cccccccccccc|}
        ...
        \multicolumn{1}{|c|}{${x_4}$}                     & \multicolumn{1}{|c|}{Sim}          & \multicolumn{1}{|c|}{Não} & \multicolumn{1}{|c|}{Sim}         & \multicolumn{1}{|c|}{Sim}  & \multicolumn{1}{|c|}{Cheio}    & \multicolumn{1}{|c|}{S}     & \multicolumn{1}{|c|}{Sim}   & \multicolumn{1}{|c|}{Não}     & \multicolumn{1}{|c|}{Tailandês}  & \multicolumn{1}{|c|}{10-30}       & \multicolumn{1}{|c|}{$y_4$ = Sim}                     \\  \hline
    \end{tabular}
    \end{adjustbox}
\end{center}
